...
#ifndef __TCM_ECC_H__
#define __TCM_ECC_H__

/* 
1. 返回值为int类型的函数，0表示成功，1表示失败。
2. 返回值为int类型的函数，TRUE表示成功，FALSE表示失败 
*/
...
*************************************************************************/
int tcm_ecc_is_point_valid(unsigned char *point, unsigned int uPointLen);
...
*************************************************************************/
int tcm_ecc_point_to_uncompressed(unsigned char *point, unsigned int uPointLen,
...
返回值：成功返回0，否则返回1
*************************************************************************/
int tcm_ecc_point_from_privatekey(const unsigned char *prikey, const unsigned int uPrikeyLen, 
								unsigned char *pubkey, unsigned int *puPubkeyLen);
...
其他：本函数只用于测试。
*************************************************************************/
int tcm_ecc_is_key_match(const unsigned char *prikey, const unsigned int uPrikeyLen, 
